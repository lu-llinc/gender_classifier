CREATE DATABASE `gender_demo_page` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

CREATE TABLE `t_cor_correction` (
  `cor_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `cor_pre_id` bigint(20) NOT NULL,
  `cor_correction` enum('male','female','correct','organisation_company','other','unknown') DEFAULT NULL,
